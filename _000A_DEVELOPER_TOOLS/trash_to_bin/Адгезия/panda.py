...
class Read(object):
    ...
    def __init__(self):
        ...
        Инициализация
        """
        self.df = pd.read_csv(LZ_gaz, header = 0)
...
class Visual(object):
    ...
    def __init__(self):
        ...
        plt.title(LENTA_NAME[2]) # реализовать вызов метода по индексу значения в коллекции
