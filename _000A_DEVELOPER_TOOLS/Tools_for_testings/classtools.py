# -*- coding: utf-8 -*-
"""
classtools.py: вывод имен классов экземпляров и всех атрибутов в виде пар имя=значение,имеющихся в экземплярах (исключая атрибуты, унаследованные от классов).Может добавляться в любые классы и способен работать с любыми
экземплярами.
"""
class AttrDisplay:
    """
