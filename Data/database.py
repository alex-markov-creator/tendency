...
data_kol_real_komp_year = pd.read_csv(parentdir+r'/Data/Показатели csv годовые/Процесс Б(7.7) Сбыт/Количество реализованных комплектов Км по годам.csv', index_col = 0)
...
data_ob_vozr_prod_year = pd.read_csv(parentdir+r'/Data/Показатели csv годовые/Процесс Б(7.7) Сбыт/Объем возвращенной продукции по годам.csv', index_col = 0)
data_ur_vip_zak_year = pd.read_csv(parentdir+r'/Data/Показатели csv годовые/Процесс Б(7.7) Сбыт/Уровень выполнения заказов по годам.csv', index_col = 0)
...
data_kol_real_komp_middle_year = pd.read_csv(parentdir+r'/Data/Показатели csv полугодие/Процесс Б(7.7) Сбыт/Количество реализованных комплектов Км по полугодиям.csv', index_col = 0)
