# -*- coding: utf-8 -*-
# version 0.2a
# author: andrew.bezzubov - 12/01/2020 year
"""
=============================================================================
...
ЛИТКОР-НН толщина 1.0 мм. - 20 Н/см, 20 Н/см, 15 Н/см;
...
|      012      | ЛИТКОР-НН толщина 1.0 мм. |   lnn_1_0,_lnn_1_0, __lnn_1_0   |
+---------------+---------------------------+---------------------------------+
...
try:
    ...
    LENTA_NAME = [
                    ...
                    'БПИ толщина 2.0 мм', 'ЛИТКОР-НН толщина 1.0 мм.'
                 ]#запись наименований
    ...
    __lnn_1_0 = _lnn_1_0.apply(lambda x: x/9.80665)
    __lst_adhaesio = [
